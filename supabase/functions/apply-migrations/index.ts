/**
 * apply-migrations  —  one-shot edge function
 * Creates profit_share_agreements and order_allocations tables.
 * Safe to call multiple times (fully idempotent).
 * Call once, then this function can be left in place harmlessly.
 */
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Use postgres.js (available in Deno edge runtime)
    ...
    return new Response(
      JSON.stringify({ ok: true, message: "Migration applied successfully" }),
